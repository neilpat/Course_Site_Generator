...
public class testSaveTest{
    ...
    public void testLoadDataPages() throws Exception {
        ...
        String filePath = "../CourseSiteGenerator/work/csgFile.json";
	...
	is.close();
        ...
        for(int i = 0; i < getArray.size(); i++)
        {
            ...
            assertEquals(red, ((TAData)dataManager).getTeams().get(i).getRed());
            assertEquals(green, ((TAData)dataManager).getTeams().get(i).getGreen());
            assertEquals(blue, ((TAData)dataManager).getTeams().get(i).getBlue());
