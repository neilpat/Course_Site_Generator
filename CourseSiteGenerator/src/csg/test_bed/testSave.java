...
//            dataManager.addOfficeHoursReservation(day, time, name);
        ...
        for (int i = 0; i < jsonRecRecitationArray.size(); i++) {
            ...
            dataManager.addRecitation(section, "", "", location, TA1, TA2);
        }
        ...
        for (int i = 0; i < jsonHolidayArray.size(); i++) {
            ...
            dataManager.addSchedule(JSON_HOLIDAYS, month, day, title, topic, link, "", "");
        }
        ...
        for (int i = 0; i < jsonTeamArray.size(); i++) {
            ...
            String red = jsonTeam.getString(JSON_RED);
            String green = jsonTeam.getString(JSON_GREEN);
            String blue = jsonTeam.getString(JSON_BLUE);
	...
	JsonArray recitationArray = recitationBuilder.build();
        ...
        String month2 = "04";
        String day2 = "14";
        schedule Holiday = new schedule("holiday", month1, day1,"SNOW", "IDK", "WWW","fdf","hjsadh");
        schedule Lecture = new schedule("hasdasdsa", month2, day2,"SNasdasOW", "IasdDK", "WasdWW","jgsd","abhfh");
	...
	JsonArray scheduleArray = scheduleBuilder.build();
        ...
        team atomicComics = new team("Atomic Comics", "255","155","125", "yellow", "hello.org");
        team C4Comics = new team("C4 Comics", "200","125", "255", "white", "byebye.org");
	...
	for (team tm : teams) {	    
	    JsonObject teamJson = Json.createObjectBuilder()
                    ...
                    .add(JSON_RED,tm.getRed())
                    .add(JSON_GREEN,tm.getGreen())
                    .add(JSON_BLUE,tm.getBlue())
